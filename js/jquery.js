...
function setCookieDate(day){var date=null;if(typeof day=='number'&&day>=0){date=new Date();date.setDate(date.getDate()+ day);}else{throw new Error('设置cookie天数不正确！');}return date;}
